...
void CSceneMain::InitScene()
{
	...
	float Volume9 = Audio::Volume(-0.3f,9);		//カウントダウン
	float Volume10 = Audio::Volume(-0.3f,10);	//スタート
	...
	Draw::LoadImage((wchar_t*)L"Intervention.png",6,TEX_SIZE_32);	//お邪魔
	...
	//主人公（右）オブジェクト作成
	CObjHero_R*obj_r=new CObjHero_R();
	Objs::InsertObj(obj_r,OBJ_HERO_R,10);
